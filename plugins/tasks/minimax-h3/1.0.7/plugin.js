...
function statusResult(task) {
  ...
  if (status === "failed" || status === "failure" || status === "cancelled" || status === "canceled" || status === "expired") {
  ...
  if (status === "running" || status === "processing" || status === "in_progress" || status === "preparing") {
