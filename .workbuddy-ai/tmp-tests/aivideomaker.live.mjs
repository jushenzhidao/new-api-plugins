...
// 版本目录自动发现：始终联调 plugins/tasks/aivideomaker/ 下最大的版本目录。
import fs, { readdirSync } from "node:fs";

const PLUGIN_DIR = new URL("../../plugins/tasks/aivideomaker/", import.meta.url);
const SEMVERS = readdirSync(PLUGIN_DIR)
...
const PLUGIN_PATH = "../../plugins/tasks/aivideomaker/" + LATEST + "/plugin.js";
const DEFAULT_BASE = "https://aivideomaker.ai";
