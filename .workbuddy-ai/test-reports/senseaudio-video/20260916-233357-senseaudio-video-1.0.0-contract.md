...
> **插件闸门结论：FAIL** — 本层（contract）通过 164 / 失败 0 / 告警 5 / 用例 169；回归 0 条
>
...
| 字段 | 值 |
| --- | --- |
| 报告 ID | `20260916-233357-senseaudio-video-1.0.0-contract` |
...
- 基线报告：`20260916-233135-senseaudio-video-1.0.0-contract`（1.0.0 · INCOMPLETE · 2026-09-16 23:31:35 +0800）
- 回归：**0** ｜ 已修复：0 ｜ 仍失败：0 ｜ 新增用例：17 ｜ 未变：152 ｜ 消失用例：1
...
```text
(node:67386) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of file:///Users/betterme/PycharmProjects/AI/new-api-plugins/plugins/tasks/senseaudio-video/1.0.0/plugin.js is not specified and it doesn't parse as CommonJS.
