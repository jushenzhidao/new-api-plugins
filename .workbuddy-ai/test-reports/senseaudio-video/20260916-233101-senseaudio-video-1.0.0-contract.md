...
| 字段 | 值 |
| --- | --- |
| 报告 ID | `20260916-233101-senseaudio-video-1.0.0-contract` |
...
- 基线报告：`20260916-233003-senseaudio-video-1.0.0-contract`（1.0.0 · INCOMPLETE · 2026-09-16 23:30:03 +0800）
- 回归：**0** ｜ 已修复：0 ｜ 仍失败：0 ｜ 新增用例：0 ｜ 未变：153 ｜ 消失用例：0
