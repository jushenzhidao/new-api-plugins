...
| 字段 | 值 |
| --- | --- |
| 报告 ID | `20260917-013735-aivideomaker-1.0.1-live` |
...
- 基线报告：`20260917-013013-aivideomaker-1.0.1-live`（1.0.1 · PASS · 2026-09-17 01:30:13 +0800）
...
result url=https://static.img2video.ai/1789580407986-bec15c0e-178a-4218-a284-214516115c3a-1639200_0_minimax_h3_1639200.mp4
usage(onComplete)={"duration":5}
artifacts=[{"key":"video","type":"video","mimeType":"video/mp4"}]
artifactKey=video
  ✓ 终态给出可访问的结果 URL
  ✓ listArtifacts 返回制品（1 个）
content request url=https://static.img2video.ai/1789580407986-bec15c0e-178a-4218-a284-214516115c3a-1639200_0_minimax_h3_1639200.mp4 credentialless=true
  ✓ 回源请求 credentialless（不携带渠道鉴权）
downloaded -> /tmp/avm-gate-t2v-2.mp4 (200, 1412849 bytes, video/mp4)
  ✓ 回源下载落盘
renderFinal={"output":[{"type":"message","status":"completed","role":"assistant","content":[{"type":"output_text","text":"<video controls src=\"https://static.img2video.ai/1789580407986-bec15c0e-178a-4218-a284-214516115c3a-1639200_0_minimax_h3_1639200.mp4\"></video>","annotations":[],"logprobs":[]}]}],"metadata":{"vendor":"aivideomaker"}}
...
```text
(node:5860) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of file:///Users/betterme/PycharmProjects/AI/new-api-plugins/plugins/tasks/aivideomaker/1.0.1/plugin.js is not specified and it doesn't parse as CommonJS.
