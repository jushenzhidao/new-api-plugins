...
| 字段 | 值 |
| --- | --- |
| 报告 ID | `20260917-012329-aivideomaker-1.0.1-e2e` |
...
```text
(node:1047) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of file:///Users/betterme/PycharmProjects/AI/new-api-plugins/plugins/tasks/aivideomaker/1.0.1/plugin.js is not specified and it doesn't parse as CommonJS.
