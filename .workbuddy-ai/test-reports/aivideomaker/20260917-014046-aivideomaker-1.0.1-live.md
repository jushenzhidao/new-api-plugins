...
| 字段 | 值 |
| --- | --- |
| 报告 ID | `20260917-014046-aivideomaker-1.0.1-live` |
...
- 基线报告：`20260917-013735-aivideomaker-1.0.1-live`（1.0.1 · PASS · 2026-09-17 01:37:35 +0800）
...
```text
poll #9 http=200 -> IN_PROGRESS 50%
poll #10 http=200 -> IN_PROGRESS 50%
poll #11 http=200 -> SUCCESS 100%
  ✓ 轮询走到终态 SUCCESS

result url=https://static.img2video.ai/1789580588203-12738bce-f8da-4548-9f14-1426babb9c13-1639206_0_minimax_h3_1639206.mp4
usage(onComplete)={"duration":5}
artifacts=[{"key":"video","type":"video","mimeType":"video/mp4"}]
artifactKey=video
  ✓ 终态给出可访问的结果 URL
  ✓ listArtifacts 返回制品（1 个）
content request url=https://static.img2video.ai/1789580588203-12738bce-f8da-4548-9f14-1426babb9c13-1639206_0_minimax_h3_1639206.mp4 credentialless=true
  ✓ 回源请求 credentialless（不携带渠道鉴权）
downloaded -> /tmp/avm-gate-t2v-3.mp4 (200, 1605035 bytes, video/mp4)
  ✓ 回源下载落盘
renderFinal={"output":[{"type":"message","status":"completed","role":"assistant","content":[{"type":"output_text","text":"<video controls src=\"https://static.img2video.ai/1789580588203-12738bce-f8da-4548-9f14-1426babb9c13-1639206_0_minimax_h3_1639206.mp4\"></video>","annotations":[],"logprobs":[]}]}],"metadata":{"vendor":"aivideomaker"}}
...
```text
(node:6601) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of file:///Users/betterme/PycharmProjects/AI/new-api-plugins/plugins/tasks/aivideomaker/1.0.1/plugin.js is not specified and it doesn't parse as CommonJS.
